...
$(document).ready(function () {
    $("#menu_1").click(function () {
        $("#menu_1").css("backgroundColor", "#df5257");
        $("#menu_2").css("backgroundColor", "white");
...
$(document).ready(function () {
    $("#menu_2").click(function () {
        $("#menu_1").css("backgroundColor", "white");
        $("#menu_2").css("backgroundColor", "#df5257");
        $("#menu_3").css("backgroundColor", "white");
        $("#menu_4").css("backgroundColor", "white");
        $("#menu_5").css("backgroundColor", "white");
        $("#menu_1").css("color", "#4C4646");
        $("#menu_2").css("color", "white");
        $("#menu_3").css("color", "#4C4646");
        $("#menu_4").css("color", "#4C4646");
        $("#menu_5").css("color", "#4C4646");
...
//加减按钮
function funJia(obj) {
    var fruitCount = obj.parentElement.children[1];
    var jianhao = obj.parentElement.children[0];
   // alert(a[6].innerHTML.replace(/[ ]/g, ""));
    //alert(a[5].innerHTML.replace(/[ ]/g, ""));
    var temp = fruitCount.is(":hidden");
    alert(temp);
    if (temp == true) {
        fruitCount.show();
        jianhao.show();
