<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="address2.aspx.cs" Inherits="QLWeiXin.lsjyWeb.address2" %>
        ...
        <div class="backgrounds" align="center">
            ...
            <ItemTemplate>
                ...
                <div class="manage_update">
                    ...
                    <br />
                    <br />
                    <a href='balance.aspx?mchid=<%# Eval("Mch_id") %>&name=<%# Eval("title") %>&geoid=<%# Eval("geotable_id") %>'>选择</a>
