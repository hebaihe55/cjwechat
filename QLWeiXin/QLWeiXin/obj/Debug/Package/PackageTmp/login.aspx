<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="QLWeiXin.login" %>
...
<head runat="server">
    ...
    <link href="lsjyWeb/css/login.css" rel="stylesheet" type="text/css" />
    <script src="lsjyWeb/js/login.js" type="text/javascript"></script>
    <script>
        ...
        <div class="backgrounds" align="center">
            <div class="title_name">
                <div id="title_name_ico">
                    <a href="javascript:history.go(-1);">      <img src="lsjyWeb/img/return_button.png" /></a>
                </div>
            ...
            <div id="logo">
             <img src="lsjyWeb/img/logo icon.png.png" />
            </div>
            <div id="txtDiv">
                <div class="txt">
                    <div class="txt_ico">
                        <img src="lsjyWeb/img/usernameicon.png.png" />
                    </div>
                ...
                <div class="txt">
                    <div class="txt_ico">
                        <img src="lsjyWeb/img/unlock icon.png.png" />
                    </div>
                    <div class="txt_textbox">
